    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="box table-responsive">
                ...
                <div class="box-body">
                    <table id="clasificaciones" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>#</th>
                        ...
                        <tbody>
                            <?php
                                ...
                                {
                                    echo '<tr>';
                                    echo '<td>' . $clasificaciones[$z]['id_servicio_clasificacion'] . '</td>';
                                    echo '<td>' . $clasificaciones[$z]['nombre_servicio_clasificacion'] . '</td>';
                                    echo '<td>' . $clasificaciones[$z]['active'] . '</td>';
                                    echo "<td> <span class='btn-group btn btn-info btn-sm' onclick=\"abrirModal(" . $clasificaciones[$z]['id_servicio_clasificacion'] . ", '". str_replace($c_replace, "", $clasificaciones[$z]['nombre_servicio_clasificacion']) . "', '" .  $clasificaciones[$z]['active'] . "')\"> <i class='fa fa-search'></i></span></td>";
                                    echo '<td>' . anchor("tpoadminv1/catalogos/servicios/editar_clasificacion/".$clasificaciones[$z]['id_servicio_clasificacion'], "<button class='btn btn-warning btn-sm' title='Editar'><i class=\"fa fa-edit\"></i></button></td>"); 
                                    echo "<td> <span class='btn-group btn btn-danger btn-sm' onclick=\"eliminarModal(" . $clasificaciones[$z]['id_servicio_clasificacion'] . ", '". str_replace($c_replace, "", $clasificaciones[$z]['nombre_servicio_clasificacion']) . "')\"> <i class='fa fa-close'></i></span></td>";
...
<script type="text/javascript">
    ...
    var eliminarModal = function(id, name){
        ...
        $('#myModalDelete').find('#mensaje_modal').html('¿Desea eliminar la clasificaci&oacute;n del servicio <b>' + name+ '</b>?');
        $('#myModalDelete').modal('show');
    }

    var eliminar = function (id){
        window.location.href = "eliminar_clasificacion/" + id;
    }
