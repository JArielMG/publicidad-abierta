        ...
        <div class="col-xs-12">
            <div class="box table-responsive">
                <div class="box-header">
                    <?php echo anchor("tpoadminv1/catalogos/campanas_avisos/agregar_tipo", "<button class='btn btn-success'><i class=\"fa fa-plus-circle\"></i> Agregar</button></td>"); ?>
                ...
                <div class="box-body">
                    <table id="tipos" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Tipos de campa&ntilde;as o avisos institucionales</th>
                                <th>Estatus</th>
                        ...
                        <tbody>
                            <?php
                                ...
                                {
                                    echo '<tr>';
                                    echo '<td>' . $tipos[$z]['id_campana_tipo'] . '</td>';
                                    echo '<td>' . $tipos[$z]['nombre_campana_tipo'] . '</td>';
                                    echo '<td>' . $tipos[$z]['estatus'] . '</td>';
                                    echo "<td> <span class='btn-group btn btn-info btn-sm' onclick=\"abrirModal(" . $tipos[$z]['id_campana_tipo'] . ", '". str_replace($c_replace, "", $tipos[$z]['nombre_campana_tipo']) . "', '" .  $tipos[$z]['estatus'] . "')\"> <i class='fa fa-search'></i></span></td>";
                                    echo '<td>' . anchor("tpoadminv1/catalogos/campanas_avisos/editar_tipo/".$tipos[$z]['id_campana_tipo'], "<button class='btn btn-warning btn-sm' title='Editar'><i class=\"fa fa-edit\"></i></button></td>"); 
                                    echo "<td> <span class='btn-group btn btn-danger btn-sm' onclick=\"eliminarModal(" . $tipos[$z]['id_campana_tipo'] . ", '". str_replace($c_replace, "", $tipos[$z]['nombre_campana_tipo']) . "')\"> <i class='fa fa-close'></i></span></td>";
...
<script type="text/javascript">
    ...
    var eliminar = function (id){
        window.location.href = "eliminar_tipo/" + id;
    }
